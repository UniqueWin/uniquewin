              ...
              <CardContent>
                {currentGame ? (
                  <>
                    ...
                    <p className="mb-2">
                      Jackpot: £{currentGame.current_prize}
                    </p>
                    <p className="mb-4">
                      Ends: {formatUKTime(currentGame.end_time)}
                    </p>
                    <Link
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <ul className="list-disc list-inside">
                  ...
                  <li>
                    Players can win unique prizes by providing a unique answer.
                  </li>
                  <li>Instant win prizes are available for certain answers.</li>
                  <li>
                    Games run daily from 8 PM to 8 PM, with a live draw at 9 PM.
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <ol className="list-decimal list-inside">
                  ...
                  <li>
                    Check the live results show for the winners announcement.
                  </li>
                </ol>
              </CardContent>
            </Card>
          ...
          >
            <Card className="mb-8">
              ...
              <CardContent>
                ...
                <p>
                  A: You can deposit credits through the "Buy Credits" section
                  in your account.
                </p>
                <h3 className="font-bold">
                  Q: What happens if my answer is not unique?
                </h3>
                <p>
                  A: If your answer is not unique, it will be marked as a
                  duplicate, and you will not win the jackpot.
                </p>
                <h3 className="font-bold">
                  Q: Can I play more than one game a day?
                </h3>
                <p>
                  A: No, each player can only participate in one game per day.
                </p>
              </CardContent>
            </Card>
          </motion.div>
