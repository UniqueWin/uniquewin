...
const Footer = () => {
  return (
    <footer className="bg-red-800 text-white py-12 mx-4 rounded-t-xl mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/how-to-play" className="hover:text-gray-300">How to Play</Link></li>
              <li><Link href="/winners" className="hover:text-gray-300">Winners</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/responsible-gaming" className="hover:text-gray-300">Responsible Gaming</Link></li>
            </ul>
          </div>
          <div>
